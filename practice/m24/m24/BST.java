...
public class BST<Key extends Comparable<Key>, Value> {
    ...
    private Node root;
    /**.
     * put counter to calculate n.o put operations
     */
    static Double putCounter = 0.0;
    /**
     * get counter to calculate no get operations.
     */
    ...
    public void display() {
        double total = putCounter + getCounter;
        System.out.println("No of Put Operations: " + putCounter);
        System.out.println("No of get Operations: " + getCounter);
        System.out.println("put ratio: " + putCounter / total * 100);
        System.out.println("get ratio: " + getCounter / total * 100);
